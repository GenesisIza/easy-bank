...
const Footer = () => (
   <div className="flex-container-foo">
       <div className="flex-item-foo first">
            <img id="principal" src={process.env.PUBLIC_URL + '/images/logowhite.svg'} alt="cargando"/><br/>
       ...
       <div className="flex-item-foo">
            <section className="ft-social">
                <ul className="ft-social-list">
                    <li><a href="localhost">About Us</a></li>
                    <li><a href="localhost">Contact</a></li>
                    <li><a href="localhost">Blog</a></li>
                </ul>
            </section>
       </div>
       <div className="flex-item-foo">
            <section className="ft-social">
                <ul className="ft-social-list">
                    <li><a href="localhost">Careers</a></li>
                    <li><a href="localhost">Support</a></li>
                    <li><a href="localhost">Privacy Policy</a></li>
                </ul>
            </section>
       </div>
       <div className="flex-item-foo last">
